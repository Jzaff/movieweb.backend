        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TopExplanation = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    allpack = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeleteDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TvshowTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Logins_Signups_SignupId",
                        column: x => x.SignupId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TvshowTypeId = table.Column<int>(type: "int", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeleteDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tvshowss", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Tvshowss_TvshowTypes_TvshowTypeId",
                        column: x => x.TvshowTypeId,
                        principalTable: "TvshowTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeriesPhotos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SeriesPhotos_Series_SeriesId",
                        column: x => x.SeriesId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TvshowsId = table.Column<int>(type: "int", nullable: true),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeleteDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TvshowPhotos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TvshowPhotos_Tvshowss_TvshowsId",
                        column: x => x.TvshowsId,
                        principalTable: "Tvshowss",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateIndex(
                name: "IX_Logins_SignupId",
                table: "Logins",
                column: "SignupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeriesPhotos_SeriesId",
                table: "SeriesPhotos",
                column: "SeriesId");

            migrationBuilder.CreateIndex(
                name: "IX_TvshowPhotos_TvshowsId",
                table: "TvshowPhotos",
                column: "TvshowsId");

            migrationBuilder.CreateIndex(
                name: "IX_Tvshowss_TvshowTypeId",
                table: "Tvshowss",
                column: "TvshowTypeId");
        }
